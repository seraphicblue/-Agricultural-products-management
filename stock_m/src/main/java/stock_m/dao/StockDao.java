...
public interface StockDao {
	...
	int inserts(@Param("scontent") String scontent, @Param("s_volume") int s_volume, @Param("s_date") String s_date,
			@Param("s_val") int s_val, @Param("userid") String userid);
	...
	int updates(@Param("scontent") String scontent, @Param("s_volume") int s_volume, @Param("ano") int ano,
			@Param("userid") String userid);

	@Select("select * from stock where userid = #{userid}")
	...
	// values('testcompany6',1,#{scontent},#{s_volume},#{s_date})")
	// int inserts(@Param("scontent") String scontent, @Param("s_volume") int
	// s_volume, @Param("s_date") String s_date);
	// main코드 수정 23.05.23
